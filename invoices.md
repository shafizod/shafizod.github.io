...
При успешном ответе статус заказа отправится в поле message. Список статусов заказов можно увидеть в Таблице №2.
